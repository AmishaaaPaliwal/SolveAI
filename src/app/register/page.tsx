...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      console.log('Calling patientsService.create...');
      ...
      toast({
        ...
        description: `Your unique patient code is: ${code}. Please save this code to share with your hospital or dietitian.`,
      });
        ...
        <div className="flex justify-center order-1 lg:order-2">
          <Card className="w-full max-w-2xl">
            <CardHeader>
              ...
              <CardDescription>
                Create your AyurTrack account. A unique patient code will be generated for hospital integration.
              </CardDescription>
            </CardHeader>
            <CardContent>
